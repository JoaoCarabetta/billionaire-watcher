...
- `bancos.csv` - Valor 1000 2025 banks ranking (100 rows). Public JSON `Bancos2025.json`. Retrieved 2026-08-26.
- `seguradoras.csv` - Valor 1000 2025 insurers ranking, ramos gerais (50 rows). Public JSON `Seguros2025.json`. Retrieved 2026-08-26.

Seed A is the full industrial ranking (1–1000) ∪ all banks ∪ all insurers. Do not add named extras (Itaúsa, Folha). `top50.csv` is not part of seed A.
